...
- `AZW3Writer.asin: String` — exposes the 15-char hex ASIN the writer stamps into EXTH 113. Deterministic in the manifest; useful for callers writing companion files keyed by ASIN (e.g. Kindle's `system/thumbnails/` folder).
