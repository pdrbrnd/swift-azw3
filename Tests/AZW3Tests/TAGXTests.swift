...
@testable import AZW3

@Suite("TAGXTag")
struct TAGXTagTests {

    @Test func decomposesBigEndianByteOrder() {
        let tag = TAGXTag(0x0102_0304)
    ...
    @Test func canonicalConstantsHaveExpectedRawValues() {
        ...
        #expect(TAGXTag.skeletonChunkCount.raw == 0x0101_0300)
        #expect(TAGXTag.skeletonGeometry.raw == 0x0602_0C00)
        #expect(TAGXTag.chunkGeometry.raw == 0x0602_0800)
        #expect(TAGXTag.end.raw == 0x0000_0001)
    }
}
